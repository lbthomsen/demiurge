...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
	...
	HAL_DAC_Start_DMA(&hdac, DAC_CHANNEL_1, (uint32_t *)dac1_buffer, BUFFER_SIZE * 2,
			DAC_ALIGN_12B_R);
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : BUILTIN_LED_Pin DBG0_Pin */
  GPIO_InitStruct.Pin = BUILTIN_LED_Pin|DBG0_Pin;
